...
import com.example.karkapazhagu.Constants;
import com.example.karkapazhagu.Extra_activities;
import com.example.karkapazhagu.Internships;
import com.example.karkapazhagu.R;
import com.example.karkapazhagu.Upload;
...
public class upload_internship extends AppCompatActivity implements View.OnClickListener {
                        ...
                        public void onComplete(Task<UploadTask.TaskSnapshot> task) {
                            task.getResult().getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    upload_intern upload=new upload_intern(editTextName.getText().toString(),editTextDescription.getText().toString(),newUri);
    ...
    public void onClick(View view) {
        if (view == buttonChoose) {
            ...
            startActivity(new Intent(getApplicationContext(), Internships.class));
        }
    }
